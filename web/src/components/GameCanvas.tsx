...
const HUD_MESSAGES: Record<string, MessageDescriptor> = {
  ...
  'Case II: level on final, {heading}, 1200\', gear and flaps down, on-speed 8.1° AOA, 140 knots': msg({ message: "Case II: level on final, {heading}, 1200', gear and flaps down, on-speed 8.1\u00b0 AOA, 140 knots" }),
