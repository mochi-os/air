...
const HUD_MESSAGES: Record<string, MessageDescriptor> = {
  ...
  'Roll out downwind: {heading}, 0.9-1.1 NM abeam ship': msg({ message: "Roll out downwind: {heading}, 0.9-1.1 NM abeam ship" }),
  ...
  'Downwind: level at 600\'; ship 0.9-1.1 NM off wing': msg`Downwind: level at 600'; ship 0.9-1.1 NM off wing`,
  ...
  'The 45: 325-375\', roll into groove, {heading}; find ball, fly ball with power': msg({ message: "The 45: 325-375', roll into groove, {heading}; find ball, fly ball with power" }),
  'Case II: level on final, {heading}, 1200\', gear and flaps down; on-speed 8.1° AOA, about 140 knots': msg({ message: "Case II: level on final, {heading}, 1200', gear and flaps down; on-speed 8.1\u00b0 AOA, about 140 knots" }),
  'HUD needles: glideslope and centreline; hold velocity vector where they cross': msg`HUD needles: glideslope and centreline; hold velocity vector where they cross`,
  'Glideslope alive: start down; 2 NM 800\', 1 NM 400\', 0.5 NM 200\'': msg`Glideslope alive: start down; 2 NM 800', 1 NM 400', 0.5 NM 200'`,
  'Case III: marshal 6000\', 250 knots, final bearing {heading}; commence when HUD clock reaches zero': msg({ message: "Case III: marshal 6000', 250 knots, final bearing {heading}; commence when HUD clock reaches zero" }),
  ...
  '10 NM: gear, full flaps, hook; on-speed 8.1° AOA by 6 NM; final bearing {heading}': msg({ message: "10 NM: gear, full flaps, hook; on-speed 8.1\u00b0 AOA by 6 NM; final bearing {heading}" }),
  'Fly needles down: 3 NM 1200\', 2 NM 800\', 1 NM 400\'': msg`Fly needles down: 3 NM 1200', 2 NM 800', 1 NM 400'`,
  'Ball call: answer looking at lens; fly ball to touchdown': msg`Ball call: answer looking at lens; fly ball to touchdown`,
  'Wave-off: full power, boards in, wings level, hold attitude; climb up angled deck, {heading}': msg({ message: "Wave-off: full power, boards in, wings level, hold attitude; climb up angled deck, {heading}" }),
  ...
  'Go around: full power, boards in, wings level, climb on runway heading {heading} to 600\'': msg({ message: "Go around: full power, boards in, wings level, climb on runway heading {heading} to 600'" }),
