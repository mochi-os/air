...
const CARRIER_MODELS={
	...
	nimitz:{ url:"vessels/nimitz/model.glb?v="+NIMITZ_MODEL_VERSION, length:333, yaw:20, bow:0, draft:0.375, deck:19,   // real USS Nimitz length. yaw:20 faces the bow to 070° (into the Midway wind) — the model's bow is +X (the retired Ford's was +Z, hence its yaw:110); both reach the same 070° recovery course. bow = the bow's bearing in the MODEL frame (0 = +X, 90 = +Z): the deck-ops frame is (yaw - bow), so carrier-local fore-aft tracks the drawn bow whatever the modeller's axes
		...
		outline:[ [-167.0,8.46],[-164.0,17.42],[-161.0,24.47],[-158.0,25.34],[-155.0,24.32],[-152.0,24.87],[-149.0,24.64],[-146.0,23.66],[-143.0,22.65],[-140.0,22.55],[-137.0,22.11],[-134.0,24.9],[-131.0,28.14],[-128.0,31.13],[-125.0,27.74],[-122.0,23.97],[-119.0,20.23],[-116.0,23.98],[-113.0,27.53],[-110.0,30.32],[-107.0,29.47],[-104.0,29.41],[-101.0,29.78],[-98.0,29.18],[-95.0,28.03],[-92.0,28.15],[-89.0,28.43],[-86.0,31.67],[-83.0,34.25],[-80.0,37.12],[-77.0,37.22],[-74.0,36.86],[-71.0,36.92],[-68.0,37.02],[-65.0,37.28],[-62.0,37.26],[-59.0,37.12],[-56.0,37.07],[-53.0,37.25],[-50.0,37.29],[-47.0,37.15],[-44.0,36.61],[-41.0,36.56],[-38.0,36.29],[-35.0,32.38],[-32.0,27.29],[-29.0,22.47],[-26.0,21.55],[-23.0,21.54],[-20.0,21.56],[-17.0,21.45],[-14.0,23.46],[-11.0,25.17],[-8.0,30.58],[-5.0,33.95],[-2.0,37.16],[1.0,36.88],[4.0,36.23],[7.0,36.67],[10.0,35.43],[13.0,31.5],[16.0,26.61],[19.0,24.54],[22.0,25.83],[25.0,27.11],[28.0,27.43],[31.0,27.81],[34.0,28.81],[37.0,29.71],[40.0,29.59],[43.0,32.72],[46.0,35.17],[49.0,38.74],[52.0,38.74],[55.0,39.2],[58.0,39.2],[61.0,38.74],[64.0,38.34],[67.0,37.32],[70.0,36.02],[73.0,33.84],[76.0,31.43],[79.0,28.99],[82.0,26.55],[85.0,24.18],[88.0,22.37],[91.0,21.31],[94.0,20.14],[97.0,21.72],[100.0,20.76],[103.0,20.6],[106.0,17.84],[109.0,17.49],[112.0,17.12],[115.0,16.85],[118.0,16.75],[121.0,16.66],[124.0,16.38],[127.0,16.03],[130.0,15.7],[133.0,15.49],[136.0,15.33],[139.0,15.12],[142.0,14.9],[145.0,14.68],[148.0,14.53],[151.0,14.48],[154.0,14.32],[157.0,14.12],[160.0,13.79],[163.0,13.62],[163.0,-11.23],[160.0,-11.37],[157.0,-11.58],[154.0,-11.78],[151.0,-11.85],[148.0,-11.92],[145.0,-11.97],[142.0,-12.34],[139.0,-12.55],[136.0,-12.93],[133.0,-13.09],[130.0,-13.28],[127.0,-13.32],[124.0,-13.58],[121.0,-13.86],[118.0,-14.26],[115.0,-14.35],[112.0,-14.64],[109.0,-14.8],[106.0,-15.11],[103.0,-17.43],[100.0,-17.69],[97.0,-17.94],[94.0,-15.94],[91.0,-16.58],[88.0,-17.91],[85.0,-20.13],[82.0,-22.46],[79.0,-24.87],[76.0,-27.27],[73.0,-29.66],[70.0,-32.05],[67.0,-34.41],[64.0,-36.8],[61.0,-37.99],[58.0,-38.04],[55.0,-37.1],[52.0,-36.41],[49.0,-35.95],[46.0,-35.54],[43.0,-35.07],[40.0,-34.55],[37.0,-34.04],[34.0,-33.5],[31.0,-32.95],[28.0,-32.34],[25.0,-31.78],[22.0,-31.24],[19.0,-30.71],[16.0,-30.16],[13.0,-31.3],[10.0,-32.33],[7.0,-33.46],[4.0,-33.19],[1.0,-32.91],[-2.0,-31.94],[-5.0,-31.23],[-8.0,-31.46],[-11.0,-32.54],[-14.0,-33.25],[-17.0,-34.98],[-20.0,-34.76],[-23.0,-34.48],[-26.0,-32.6],[-29.0,-32.66],[-32.0,-32.76],[-35.0,-32.97],[-38.0,-33.0],[-41.0,-32.98],[-44.0,-32.81],[-47.0,-32.79],[-50.0,-32.83],[-53.0,-32.84],[-56.0,-33.03],[-59.0,-33.18],[-62.0,-33.35],[-65.0,-33.17],[-68.0,-33.17],[-71.0,-33.05],[-74.0,-33.11],[-77.0,-32.99],[-80.0,-32.96],[-83.0,-33.08],[-86.0,-30.3],[-89.0,-26.32],[-92.0,-23.67],[-95.0,-23.05],[-98.0,-24.29],[-101.0,-24.04],[-104.0,-25.01],[-107.0,-25.34],[-110.0,-25.01],[-113.0,-26.44],[-116.0,-27.39],[-119.0,-30.03],[-122.0,-28.27],[-125.0,-23.8],[-128.0,-18.19],[-131.0,-14.86],[-134.0,-14.66],[-137.0,-14.47],[-140.0,-14.33],[-143.0,-14.28],[-146.0,-14.13],[-149.0,-13.89],[-152.0,-13.56],[-155.0,-13.31],[-158.0,-12.92],[-161.0,-12.45],[-164.0,-9.81],[-167.0,-7.4] ] } }; // deck polygon TRACED FROM THE NIMITZ deck grid (84 pts, 1.5 m cells) — the Ford placeholder was narrower in places and the physics dropped jets through visually-solid deck near the edges
...
function fly_player(dt){
	...
	const controls={ pitch:THREE.MathUtils.clamp(input.pitch,-1,1), roll:THREE.MathUtils.clamp(input.roll,-1,1), yaw:THREE.MathUtils.clamp(input.yaw,-1,1),   // RAW stick: cfg.sens used to scale these (the removed Sensitivity slider genuinely was a flight-control gain — a saved sens!=1 silently rescaled the whole stick)
		...
		reheat:ownship.burner??0, brake:input.brake || sim_time<test_idle,   // scenario rollout: the script's pilot rides the brakes — a hands-off free roll ran 1.4 km off the runway end into the lagoon (the "crashes as it stops" report, live-traced to why:"sea")
...
addEventListener("pointerdown",()=>{ audio_gesture(); try{ window.focus(); }catch(e){} },{ signal });   // clicks are user activations too: without this, a mouse-started carrier mission is silent until the first keypress
